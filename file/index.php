    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
         <div class="navbar-header">
            ...
            <a href="index.html" class="navbar-brand">Wasafiritransporters</a>
         </div>
         ...
         <div class="collapse navbar-collapse dropdown">
            <ul class="nav navbar-nav navbar-right">
              ...
              <ul class="dropdown-menu" role="menu" >
               ...
               <li>
                  <a href="#my-modal-about" data-toggle="modal">About</a>
               </li>
               <li>
   ...
   <!--  <div class="jumbotron text-center">
        ...
        <div class="row">
          ...
          <div class="panel-group" id="faq">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a href="#faq-one" data-toggle="collapse" data-parent="faq">Lorem ipsum dolor sit amet</a>
                </h4>
              </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a href="#faq-two" data-toggle="collapse" data-parent="faq">Lorem ipsum dolor sit amet</a>
                </h4>
              </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a href="#faq-three" data-toggle="collapse" data-parent="faq">Lorem ipsum dolor sit amet</a>
                </h4>
              </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a href="#faq-four" data-toggle="collapse" data-parent="faq">Lorem ipsum dolor sit amet</a>
                </h4>
              </div>
      ...
      <div class="col-sm-4">
        ...
        <div class="panel panel-default">
           ...
           <div class="panel-body bg-grey">
              <p><span class="glyphicon glyphicon-envelope"></span> Contact Us</p>
              <p><span class="glyphicon glyphicon-print"></span> Print E-ticket</p>
              <p><span class="glyphicon glyphicon-question-sign"></span> FAQs</p>
              <p><span class="glyphicon glyphicon-briefcase"></span> Manage your bookings</p>
              <p><span class="glyphicon glyphicon-phone-alt"></span> Problems / Complains</p>
              <p><span class="glyphicon glyphicon-user"></span> Customer Service</p>
           </div>
        </div>
        <!-- Why choose us -->
        <div class="panel panel-default">
          ...
          <div class="panel-body bg-grey">
            <!-- Option one -->
            <div class="row">
              <div class="col-sm-2" style="font-size: 1.7em; margin-top: 1.5em;"><span class="glyphicon glyphicon-cog"></div>
              <div class="col-sm-10">
                <b><i>Options</i></b>
            ...
            <!-- Option two -->
            <div class="row">
              <div class="col-sm-2" style="font-size: 1.7em; margin-top: 1.5em;"><span class="glyphicon glyphicon-time"></div>
              <div class="col-sm-10">
            ...
            <!-- Option three -->
            <div class="row">
              <div class="col-sm-2" style="font-size: 1.7em; margin-top: 1.5em;"><span class="glyphicon glyphicon-ok"></div>
              <div class="col-sm-10">
                <b><i>Best Price</i></b>
            ...
            <!-- Option four -->
            <div class="row">
              <div class="col-sm-2" style="font-size: 1.7em; margin-top: 1.5em;"><span class="glyphicon glyphicon-thumbs-up"></div>
              <div class="col-sm-10">
    ...
    <article>
      ...
      <section class="last">
        ...
        <a href="#">
          <img src="../images/icons/facebook.jpg" alt=""> <span>facebook</span>
        </a>
        <a href="#">
          <img src="../images/icons/tweeter.gif" alt=""> <span>twitter</span>
        </a>
        <a href="#">
